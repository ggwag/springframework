							...
							<div class="card-body">
									...
									<form id="joinForm" method="post" action="#" >
									   ...
									   <div class="input-group">
									      ...
									      <input id="mname" type="text" name="mname" class="form-control"></input>
									   </div>
									   ...
									   <div class="input-group">
									    ...
									    <div class="input-group">
									      ...
									      <input id="mjob" type="text" name="mjob" class="form-control"></input>
									      		
									   </div>
									   
									   <div class="input-group">
									      <div class="input-group-prepend"><span class="input-group-text"><spring:message code="joinForm.city"/></span></div>
									      <input id="mcity" type="text" name="mcity" class="form-control"></input>
									   </div>								   
