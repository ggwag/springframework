       ...
       <div id="collapseFour" class="accordion-collapse collapse ${chNum=='ch04'?'show':''}" data-bs-parent="#accordionExample">
         <div class="accordion-body">
            <ul>
               ...
               <li><a href="${pageContext.request.contextPath}/ch04/membershipForm">회원가입 폼</a></li>
            </ul>
         </div>
       </div>
     </div>
     ...
     <div class="accordion-item">
       ...
       <div id="collapseNine" class="accordion-collapse collapse ${chNum=='ch09'?'show':''}" data-bs-parent="#accordionExample">
		 ...
		 <div class="accordion-item">
		     ...
		     <div class="accordion-item">
		       <h2 class="accordion-header">
		         <button class="accordion-button ${chNum=='ch11'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
		           Ch11. 국제화		         
		         </button>
		       </h2>
		     ...
		     <div class="accordion-item">
		       <h2 class="accordion-header">
		         <button class="accordion-button ${chNum=='ch12'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse12" aria-expanded="false" aria-controls="collapse12">
		           Ch12. 의존성 주입(DI)	         
		         </button>
		       </h2>
		       <div id="collapse12" class="accordion-collapse collapse ${chNum=='ch12'?'show':''}" data-bs-parent="#accordionExample">
		         <div class="accordion-body">
		            <ul>
					   ...
					   <li><a href="${pageContext.request.contextPath}/ch12/diByAnnotation">Annotation 설정으로 관리빈 생성</a></li>
 			...
 			<div class="accordion-item">
		       <h2 class="accordion-header">
		         <button class="accordion-button ${chNum=='ch13'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse13" aria-expanded="false" aria-controls="collapse13">
		           Ch13. 데이터베이스 연동	         
		         </button>
		       </h2>
		     ...
		     <div class="accordion-item">
		       <h2 class="accordion-header">
		         <button class="accordion-button ${chNum=='ch15'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse15" aria-expanded="false" aria-controls="collapse15">
		           Ch15. 트랜잭션 처리	         
		         </button>
		       </h2>
