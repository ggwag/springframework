...
public class Ch03Controller {
	...
	public String receiveParamData(
		...
		model.addAttribute("param1",param1);  //얘네가 $ { } 에 들어감
	...
	public String requestParamAnnotation(
		...
		model.addAttribute("chNum","ch03");
		model.addAttribute("param1",arg1);  //얘네가 $ { } 에 들어감
	...
	public String requestParamAnnotationRequired(
			...
			@RequestParam(required=true) String param2,  //required true
			String param3,
			String param4,
			String param5,
			String param6, 
	...
	public String requestParamAnnotationDefaultValue(
			...
			String param4,
			String param5,
			@RequestParam(defaultValue="기본값") String param6, //default 값을 주고싶다
			Model model) {
		log.info("실행");
	...
	public String typeChange(
			...
			/*@RequestParam(defaultValue="기본값") String param6, //default 값을 주고싶다*/
			@RequestParam(defaultValue="0") int param6, //int 값이 넘어오지 않을 경우 0을 기본값으로 준다
			Model model) {
		log.info("실행");
	...
	public String getDto(
			//@ModelAttribute("dto") 가 생략되면 클래스 이름 소문자 첫자로 ch03Dto로 JSP에서 사용
			//양식의 데이터를 받을 경우 가급적이면 dto로 받자.
			//member 클래스로 가입 받자.
			@ModelAttribute("dto") Ch03Dto dto, Model model) { //클래스의 첫자를 소문자로 한 이름
		log.info("실행");
		log.info("param1: " + dto.getParam1());
		log.info("param2: " + dto.getParam2());
		log.info("param3: " + dto.getParam3());
		log.info("param4: " + dto.isParam4());  //boolean type = is로 시작
	...
	@ResponseBody
	public String getAjaxParams(Ch03Dto dto) { //JSON을 리턴하는 String
		//JSON으로 보내기
